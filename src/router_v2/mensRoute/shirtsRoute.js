const shirtModal=require('../../models/mensModal/shirtModal')
...
Router.route('/addShrit/:brandname').post(shirtImage.single("shirtImg"),async(req,res)=>{
    ...
    try {
        ...
        await brandData.menShirts.push(newresult)
...
Router.route('/getMenShirts').get(async(req,res)=>{
    try {
...
Router.route('/deleteMenShit/:id').delete(async(req,res)=>{
    try {
