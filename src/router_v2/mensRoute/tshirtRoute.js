const TshirtModal=require('../../models/mensModal/tshirtModal')
...
Router.route('/addMenTShrit/:brandname').post(tshirtImage.single("TshirtImg"),async(req,res)=>{

    
    try {
if(req.body.name.toLowerCase()!=="men_tshirt"){
    ...
    //    console.log(brandData)
        ...
        await brandData.menTshirts.push(newresult)
...
Router.route('/getMenTShirts').get(async(req,res)=>{
    try {
...
Router.route('/deleteMenTShit/:id').delete(async(req,res)=>{
    try {
